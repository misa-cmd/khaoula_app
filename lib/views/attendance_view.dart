// attendance_view.dart - Interface Employé
...
class _AttendanceViewState extends State<AttendanceView> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<EmployeeController>(context, listen: false).loadTodayStatus());
  }
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: controller.hasCheckedIn || controller.isPermanentlyOut
                        ? null
                        : () async {
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: controller.hasCheckedIn ? Colors.grey : Colors.green,
                      foregroundColor: Colors.white,
                ...
                // Bouton de sortie (visible seulement après pointage d'entrée)
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: (!controller.hasCheckedIn || 
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: (!controller.hasCheckedIn || controller.hasCheckedOut) 
                          ? Colors.grey 
                          : Colors.red[600],
                      foregroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(vertical: 16),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: stats['lateCount'] > 0 ? Colors.red : Colors.green,
                                  ),
                                ),
                              ],
                            ),
  ...
  void _handleEarlyExit(EmployeeController controller) async {
    final now = DateTime.now();
